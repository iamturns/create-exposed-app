...
This project is authored and maintained by <%- authorName %> ([<%- authorWebsite %>](<%- authorWebsite %>) / [@<%- authorTwitter %>](https://twitter.com/<%- authorTwitter %>)).

A big thank you to all [contributors](https://github.com/<%- authorGithub %>/<%- packageName %>/graphs/contributors) 🏆

## License

Open-source under [MIT License](https://github.com/<%- authorGithub %>/<%- packageName %>/blob/master/LICENSE).
...
Sorry about that. Please submit a bug report using the [GitHub issue tracker](https://github.com/<%- authorGithub %>/<%- packageName %>/issues).

### I wish something was different…

Keen to hear all ideas in [GitHub discussions](https://github.com/<%- authorGithub %>/<%- packageName %>/discussions).
...
Ask away in [GitHub discussions](https://github.com/<%- authorGithub %>/<%- packageName %>/discussions).
