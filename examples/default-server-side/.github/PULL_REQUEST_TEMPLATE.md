...
- [ ] Checked for [duplicate pull requests](https://github.com/batman/create-exposed-app-default-server-side-example/pulls)
...
- [ ] Fixing a bug? An open [bug report](https://github.com/batman/create-exposed-app-default-server-side-example/labels/bug) exists.
